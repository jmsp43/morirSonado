  ...
  return (
    <div className="itemOnMenu">
        <form onSubmit={editTheItem}>
            Name:<input type='text' name='name' defaultValue={foodItem.name}/>
        Description:<input type='text' name='description' defaultValue={foodItem.description} />
        Price:<input type='number' name='price' defaultValue={foodItem.price} />
            <input type='submit' />
        </form>
      <br/>
